...
const DEFAULT_ENV: Omit<Env, 'REPORT_KV' | 'TOKEN_DB'> = {
  ...
  GMAIL_INTERNAL_REFRESH_TOKEN: 'test-gmail-internal-refresh-token',
  GMAIL_INTERNAL_SENDER_EMAIL: 'internal.sender@example.com',
  GMAIL_INTERNAL_SENDER_NAME: 'Internal Sender',
